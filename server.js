...
const stripe = require('stripe')('pk_live_51KRid6JhNHZfzXZ6yghejd32UnPwydIt4GLTSRzoMT4dr8uHQwvNk4F5bzvMyr8QEcYhJzeEG7ehD2b5lkTtRZUn00C7Q4H6tG');
    ...
    if(itemName != null){
        const session = await stripe.checkout.sessions.create({
            ...
            //cancel_url: 'http://localhost:8080/cancel.html',
             success_url: 'https://www.buorgoldengreenresorts.homes/success.html',
            cancel_url: 'https://www.buorgoldengreenresorts.homes/cancel.html',
            payment_intent_data: {
